package com.sopt.week3.domain.global;

import com.sopt.week3.domain.global.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleNotFoundException(NotFoundException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ErrorResponse.of(ErrorMessage.BLOG_NOT_FOUND));
    }
